<x-app-layout>
    ...
    <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 bg-white border-b border-gray-200 flex items-center justify-center mt-6">

                    <!-- Validation Errors -->
                    <div>
                        <x-auth-validation-errors class="mt-4 mb-4" :errors="$errors"></x-auth-validation-errors>
                    </div>
                        ...
                        <form method="post" action="/update-roulette-settings" class="">
                            ...
                            @if(config('settings.monday') ==='true')
                                <div class="block">
                                    ...
                                    <x-input id="monday" name="monday" type="checkbox" value="true"
                                             checked></x-input>
                                </div>
                            @else
                                <div class="block">
                            ...
                            @if(config('settings.tuesday') ==='true')
                                <div class="block">
                                    ...
                                    <x-input id="tuesday" name="tuesday" type="checkbox" value="true"
                                             checked></x-input>
                                </div>
                            @else
                                <div class="block">
                            ...
                            @if(config('settings.friday') ==='true')
                                <div class="block">
                                    ...
                                    <x-input id="friday" name="friday" type="checkbox" value="true"
                                             checked></x-input>
                                </div>
                            @else
                                <div class="block">
                            ...
                            <x-input type="number" id="participants" name="participants"
                                     value="{!! config('settings.number_of_participants')!!}"></x-input>
        ...
        <div
            class="block justify-items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
            <a href="/create-event">Launch roulette!</a>
        </div>
